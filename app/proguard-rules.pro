...
-keepclassmembers class test.app.everything.features.list.domain.ArticleData { *; }
-keepclassmembers class test.app.everything.features.list.domain.ArticleSource { *; }

# Keep custom Application class and its methods
-keep class test.app.everything.MyApplication { *; }
...
-keepclassmembers class com.test.footballleague.features.list.presentaion.** { *; }
-keepclassmembers class com.test.footballleague.features.list.domain.** { *; }
-keepclassmembers class com.test.footballleague.core.** { *; }
-keepclassmembers class com.test.footballleague.network.** { *; }
